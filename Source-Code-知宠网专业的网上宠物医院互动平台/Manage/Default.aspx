...
<i class="zi zi_bars"></i>
	...
	<ul class="nav navbar-nav" id="nav_myTopnav">
		...
		<li class="nav-item menu11 sys_index_outbtn"><a href="/AdminMVC/COM/Logout"><i class="zi zi_signoutalt" zico="出口标志"></i> 退出</a></li>
	</ul>
	</div>	
</nav>
...
<i class="zi zi_search" zico="搜索" onClick="SearchPage();"></i> </div>
</div>
...
<%--					<li id="menu3_5_1"><a href="javascript:;" data-url="/AdminMVC/Sale/SaleByDay">按日统计</a></li>
				...
				<ul id="menu3_10" class="m_left_ulin">
					<li class="menu_tit"><i class="zi zi_forDown" zico="下指"></i>IDC管理</li>     
			...
			<div id="menu4" class="m_left_ul">
				<ul class="m_left_ulin" id="menu4_2">
					<li class="menu_tit"><i class="zi zi_forDown" zico="下指"></i> 黄页管理</li>
			...
			<div id="menu5" class="m_left_ul">
				...
				<li class="menu_tit"><i class="zi zi_forDown" zico="下指"></i> 组卷配置</li>
				...
				<ul class="m_left_ulin" id="menu5_10">
					<li class="menu_tit"><i class="zi zi_forDown" zico="下指"></i> 字体管理</li>
			...
			<div id="menu6" class="m_left_ul">
				...
				<ul class="m_left_ulin" id="menu6_9">
					<li class="menu_tit"><i class="zi zi_forDown" zico="下指"></i> 用户画像</li>
			...
			<div id="menu7" class="m_left_ul">
				...
				<li class="pl-0"><p class="menu_tit laybtn below"><i class="zi zi_forDown" zico="下指"></i> 广告管理</p>
					<ul>
				...
				<li class="pl-0"><p class="menu_tit laybtn below"><i class="zi zi_forDown" zico="下指"></i> 名片设计</p>
						<ul>
				...
				<ul class="m_left_ulin" id="menu7_8">
					<li class="menu_tit"><i class="zi zi_forDown" zico="下指"></i> 版权中心</li>
			...
			<div id="menu8" class="m_left_ul">
				...
				<ul class="m_left_ulin" id="menu8_2">
					...
					<li id="menu8_2_6"><a href="javascript:;" data-url="Shop/SystemOrderModel.aspx?Type=0">订单模型</a></li>
				</ul>
				...
				<ul class="m_left_ulin" id="menu8_10">
					<li class="menu_tit"><i class="zi zi_forDown" zico="下指"></i> 插件管理</li>
			...
			<div id="menu10" class="m_left_ul">
				...
				<ul class="m_left_ulin" id="menu10_3">
					<li class="pl-0"><p class="menu_tit laybtn below"><i class="zi zi_forDown" zico="下指"></i> 智能硬件</p>
						<ul>
					...
					<li class="pl-0"><p class="menu_tit laybtn below"><i class="zi zi_forDown" zico="下指"></i> 在线监控</p>
						<ul>
				...
				<ul class="m_left_ulin" id="menu10_4">
					<li class="menu_tit"><i class="zi zi_forDown" zico="下指"></i> 消息推送</li>
				...
				<ul class="m_left_ulin" id="menu10_5">
					<li class="menu_tit"><i class="zi zi_forDown" zico="下指"></i> 头条管理</li>
				...
				<ul class="m_left_ulin" id="menu10_7">
					<li class="menu_tit"><i class="zi zi_forDown" zico="下指"></i> 百变微站</li>
				...
				<ul class="m_left_ulin" id="menu10_6">
					<li class="menu_tit"><i class="zi zi_forDown" zico="下指"></i> H5场景</li>
					<div class="input-group">
					...
					<li class="pl-0"><p class="menu_tit laybtn below"><i class="zi zi_forDown" zico="下指"></i> 动力问券</p>
						<ul>
			...
			<div id="menu11" class="m_left_ul">
				...
				<ul class="m_left_ulin" id="menu11_10">
					<li class="menu_tit"><i class="zi zi_forDown" zico="下指"></i> 动力设计</li>
						<div class="input-group ">
			...
			<div id="FrameTabs" style="overflow: hidden; width: 100%;">
				...
				<div class="tab-strip-wrap ">
					<ul class="tab-strip pull-left" id="tab_ul" style="position: fixed;">
						<li class="current first" id="iFrameTab1"><a href="javascript:"><span id="frameTabTitle"><%=Resources.L.新选项卡%></span></a><a class="closeTab" title="关闭"><i class="zi zi_times" zico="移动箭头"></i></a></li>
						<li class="end addnav" id="newFrameTab"><a title="<%=Resources.L.新选项卡%>" href="javascript:"><i class="zi zi_plus" zico="加号黑"></i></a></li>
					</ul>
...
<div class="manage_mobilemenu">
	...
	<div class="manage_mobilemenu_c">
		<ul>
			<li><a href="/" target="_blank" title="网站首页"><i class="zi zi_home" zico="家"></i> 网站首页</a></li>
			<li><a href="/user/" target="_target" title="ALT+U<%=Resources.L.进入会员中心 %>"><i class="zi zi_user" zico="用户标志"></i> 会员中心</a></li>
			...
			<li><a href="/AdminMVC/COM/Logout" title="退出系统"><i class="zi zi_signoutalt" zico="出口标志"></i> 退出系统</a></li>
		</ul>
	</div>
</div>
