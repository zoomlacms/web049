$(function(){
	...
	next_btn.click(function(){	 
		...
		$('.solu-item-active').children().stop().animate({"height":390,"marginTop":0}).parent().prev().children().stop().animate({"height":340,"marginTop":20});
	...
	prev_btn.click(function(){
		...
		$('.solu-item-active').children().stop().animate({"height":390,"marginTop":0}).parent().next().children().stop().animate({"height":340,"marginTop":20});
