...
<!--        <div class="bordered address_div card-header mb-2"><span class="address_head">填写并核对订单信息</span></div>-->
        <div class="bordered card" runat="server" id="Address_Div">
            <div class="card-header" onClick="showlistbox('#shopuserMap')"><i class="fa fa-pencil-square-o strong"> 收货人信息</i>
             <button type="button" class="btn btn-info btn-sm ml-2" onclick="AddAddress();"><i class="fa fa-adn"></i> 添加新地址</button></div>
            <section cite="card-header" id="shopuserMap">
        ...
        <div class="bordered card">
			<div class="card-header mb-1" onClick="showlistbox('.arsInfo_wrap')">
			用户自提取商品
			</div>
			<div class="arsInfo_wrap card-body">
			<div class="input-group mb-3">
			  <div class="input-group-prepend">
				<span class="input-group-text" id="basic-addon1">联系人</span>
			  </div>
        ...
        <div class="bordered" runat="server" visible="false" id="wx_address">
            <label onclick="wx_openAddress();" class="btn btn-default btn-sm arsItem">
                <i class="fa fa-wechat"></i> 使用微信收货地址
                <input type="radio" value="wechat" name="ars_chk"/>
            </label>
            <div class="arsInfo_wrap">
                <table class="table table-bordered table-striped">
                    <tr><td scope="col">收货人</td><td><input type="text" class="form-control" id="wxad_name" name="wxad_name" /></td></tr>
                    <tr><td scope="col">手机</td><td><input type="text" class="form-control" id="wxad_mobile" name="wxad_mobile" /></td></tr>
                    <tr><td scope="col">省份城市</td><td><input type="text" class="form-control" id="wxad_city" name="wxad_city" /></td></tr>
                    <tr><td scope="col">详细地址</td><td><input type="text" class="form-control" id="wxad_address" name="wxad_address" /></td></tr>
                </table>
            </div>
        </div>
        ...
        <div class="card bordered">
            <div class="card-header mb-1 shop_list_t" onClick="showlistbox('.orderbody')"><i class="fa fa-cubes strong">商品清单: </i>
            ...
            <div class="card-body indent orderbody">
                ...
                <tr class="shop_tabtr"><td>商品</td><td></td><td>金额</td><td hidden>优惠</td><td>数量</td><td class="move_d_none">状态</td></tr>
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Panel runat="server" Visible='<%#(Eval("Class","")=="0"?true:false) %>'>
                                                        <tr>
                                                            ...
                                                            <td class="tdtext text-danger" hidden><%#GetDisCount()%></td>
                                                            <td class="tdtext">x <%#Eval("Pronum") %></td>
                                                            <td class="tdtext cartStock move_d_none"><%#GetStockStatus() %></td>
                                                        </tr>
														<tr>
														<div><asp:Label runat="server" ID="Present_HTML"></asp:Label></div>
														</tr>
                                                    </asp:Panel>
                                                </ItemTemplate>
                                        </asp:Repeater>
                ...
                <tr>
                    <td colspan="6">
                        <div class="text-right total_count_div">
                            <div><span><span runat="server" id="itemnum_span" class="text-success">1</span>件商品,总商品金额：</span><i class="fa fa-rmb" runat="server" id="totalmoney_span1">0.00</i>
                               <%-- <span>余额:<span id="totalPurse_sp"></span></span>
                                <span>银币:<span id="totalSicon_sp"></span></span>
                                <span>积分:<span id="totalPoint_sp"></span></span>--%>
                            </div>
                            <div hidden><span>优惠券：</span><i class="fa fa-rmb" id="arrive_money_sp">0.00</i></div>
                            <div hidden><span>积分折扣：</span><i class="fa fa-rmb" id="point_money_sp">0.00</i></div>
	...
	<span class="Settlement_tex total">应付总额: <i runat="server" id="totalmoney_i" class="fa fa-rmb">0.00</i></span>
...
<script>
    ...
    function wx_openAddress(){
        wx.openAddress({
            ...
            fail:function(res){console.log("加载微信地址数据失败");}
        })};
</script>
</div>
<script>
    ...
    exp.init = function () {
        ...
        $(".arsItem").click(function () {
            ...
            console.log($(this).parent(".bordered").find(".arsInfo_wrap").length);
