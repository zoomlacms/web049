...
<style>.cart_table_th{width: 100%;}.coatShop_title{line-height: initial;}</style>
...
<table id="EGV" class="table-hover table-sm cart_table_th">
<tr class="shop_tabtr">
	<th></th>
		...
		<tbody class="cart_body">
			...
			<asp:Repeater runat="server" ID="ProRPT" OnItemDataBound="ProRPT_ItemDataBound">
				<ItemTemplate>
					...
					<tr><asp:Label runat="server" ID="Present_HTML"></asp:Label></tr>
                    </tr>
				</ItemTemplate>
			</asp:Repeater>
		</tbody>
...
//	console.log(cart_Ting.eq(iseq).height());
	...
	$("#SelectObj i").attr("class","fa fa-check-circle-o");
	}else{
	$("#SelectObj").attr("data-xz",true);
	$("#SelectObj i").attr("class","fa fa-check-circle");
	}
	}
